  ...
  return (
    <div className="space-y-6">
      ...
      <div className="text-center">
        <h2 className="text-3xl font-sniglet font-normal text-gray-800 mb-2">7-Day Weather Forecast</h2>
        <p className="text-gray-600 font-sniglet font-normal">Plan your week with confidence</p>
      </div>
      ...
      <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-7 gap-4">
        {forecast.map((day, index) => (
          <div key={index} className="flex flex-col">
            ...
            {/* Weather Card */}
            <div
              className={`bg-gradient-to-br ${getWeatherGradient(day.weather, index)} rounded-2xl p-4 text-gray-700 shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-105 relative overflow-hidden aspect-[3/4] flex flex-col`}
            >
            {/* Background Pattern */}
            ...
            <div className="relative z-10 flex flex-col h-full">
              ...
              <div className="flex items-center justify-between mb-3">
                <h3 className="font-sniglet text-base font-normal">
              ...
              <div className="text-center mb-3">
                <p className="font-sniglet text-sm font-normal capitalize">{day.weather}</p>
                <p className="font-sniglet text-xs font-normal opacity-90 mt-1">
      ...
      <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-6 shadow-lg">
        <h3 className="font-sniglet text-xl font-normal text-gray-800 mb-4 text-center">
          Weekly Summary
        </h3>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-center">
          <div>
            <p className="font-sniglet text-sm font-normal text-gray-600">Sunny Days</p>
            <p className="font-sniglet text-2xl font-normal text-yellow-500">
              {forecast.filter(day => day.weather === 'sunny').length}
            </p>
          </div>
          <div>
            <p className="font-sniglet text-sm font-normal text-gray-600">Rainy Days</p>
            <p className="font-sniglet text-2xl font-normal text-blue-500">
              {forecast.filter(day => day.weather === 'rainy').length}
            </p>
          </div>
          <div>
            <p className="font-sniglet text-sm font-normal text-gray-600">Cloudy Days</p>
            <p className="font-sniglet text-2xl font-normal text-gray-500">
              {forecast.filter(day => day.weather === 'cloudy').length}
            </p>
          </div>
          <div>
            <p className="font-sniglet text-sm font-normal text-gray-600">Stormy Days</p>
            <p className="font-sniglet text-2xl font-normal text-purple-500">
